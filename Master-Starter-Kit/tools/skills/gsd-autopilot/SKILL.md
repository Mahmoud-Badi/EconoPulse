...
1. `Master-Starter-Kit/tools/scripts/gsd-autopilot.sh` (in the project)
2. `gsd-autopilot.sh` (project root)
...
```bash
SCRIPT=""
if [ -f "Master-Starter-Kit/tools/scripts/gsd-autopilot.sh" ]; then
  SCRIPT="Master-Starter-Kit/tools/scripts/gsd-autopilot.sh"
